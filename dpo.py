...
class ScriptArguments:
    ...
    # training parameters
    model_path: Optional[str] = field(default="runs/sft/final_checkpoint/final_merged_checkpoint", metadata={"help": "the location of the SFT model"})
    tokenizer_path: Optional[str] = field(default="runs/sft", metadata={"help": "the location of the tokenizer"})
    ...
    output_dir: Optional[str] = field(default="runs/dpo", metadata={"help": "the output directory"})
...
if __name__ == "__main__":
    ...
    train_dataset, eval_dataset = get_itineraries(data_path="test/itinerary_3.json", test_size=script_args.test_size)
